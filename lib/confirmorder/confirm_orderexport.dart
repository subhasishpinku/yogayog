...
import 'package:yogayog/Payment/payment_national_export_wallet_screen.dart';
...
class ConfirmOrderExport extends StatefulWidget {
  ...
  @override
  State<ConfirmOrderExport> createState() => _ConfirmOrderState();
}

class _ConfirmOrderState extends State<ConfirmOrderExport> {
  ...
  void initState() {
    super.initState();
    final drop = _drop;
    _dropNameController = TextEditingController(text: _value(drop, 'name'));
    ...
    try {
      ...
      if (ledger.currentBalance >= widget.total) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => PaymentWalletNationalExportWalletScreen(
              amount: widget.total,
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => PaymentNationalScreenExport(
              amount: widget.total,
              orderPayload: orderPayload,
            ),
          ),
