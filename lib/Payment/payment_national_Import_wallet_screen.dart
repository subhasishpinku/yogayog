...
class PaymentWalletNationalImportWalletScreen extends StatelessWidget {
  const PaymentWalletNationalImportWalletScreen({
    super.key,
  ...
  Future<void> _payFromWallet(BuildContext context) async {
    final provider = context.read<PaymentNationalImportProvider>();
  ...
  Widget build(BuildContext context) {
    final isLoading = context.watch<PaymentNationalImportProvider>().isLoading;
